...
public class BottledWaterFragment extends Fragment {

    public static final String SQUARE_URL = "http://resources.click2drinkph.store/php/getBottledWater.php";
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.bottled_water_layout,container,false);
...
//                            Toast.makeText(getActivity(), e.getLocalizedMessage(), Toast.LENGTH_LONG).show();
                        ...
                        mAdapter = new DispenserAdapter(getContext(), bottleWater);
