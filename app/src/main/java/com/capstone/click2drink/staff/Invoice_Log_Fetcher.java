...
public class Invoice_Log_Fetcher {
    ...
    public Invoice_Log_Fetcher(String order_number, String total_price,
                                 String total_gallons, String date_ordered, String adress_id){
