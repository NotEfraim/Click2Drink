...
public class view_delivered_orders extends AppCompatActivity {

    private static String View_Order_URL = "http://resources.click2drinkph.store/php/view_purchase_history.php";
    ...
    public void getOrderedProducts(String order_number){
        ...
        layoutManager = new LinearLayoutManager(view_delivered_orders.this,
...
//                           Toast.makeText(getApplicationContext(), e.getLocalizedMessage(), Toast.LENGTH_LONG).show();
                        ...
                        adapter_view_orders = new Adapter_View_Orders(view_delivered_orders.this,product_data);
