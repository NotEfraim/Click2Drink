...
public class DispenserGallonFragment extends Fragment {

    public static final String DISPENSER_URL = "http://resources.click2drinkph.store/php/getDispenser.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.dispenser_layout,container,false);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, DISPENSER_URL,
...
//                            Toast.makeText(getActivity(), e.getLocalizedMessage(), Toast.LENGTH_LONG).show();
                        ...
                        mAdapter = new DispenserAdapter(getContext(), product_dispensers);
