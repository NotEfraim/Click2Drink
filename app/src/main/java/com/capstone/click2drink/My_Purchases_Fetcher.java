...
public class My_Purchases_Fetcher {
    ...
    public My_Purchases_Fetcher(String order_id, String product_id,
                                 String shop_id, String product_name,
                                String product_price, String image_url, String product_quantity,
                                String order_number, String received_on){
